...
#define SWIC_BASE(i) (0xB82F9000 + i * 0x1000)

#define STATUS(swic) *(unsigned int *)(swic + 0x04)
#define MODE_CR(swic) *(unsigned int *)(swic + 0x0C)
...
// SPFMIC
#define SPFMIC_BASE 0xb82F7000
#define SPFMIC_OFFSET 0x1000

#define SPFMIC0        *((volatile int *)(0xb82F7000)
#define SPFMIC1        *((volatile int *)(0xb82F8000)
...
// EMAC
#define EMAC_BASE(i) (0xb82FD000 + (i) * 0x1000)

#define EMAC_MODE_CSR(i) *((volatile int *)(EMAC_BASE(i) + 0x0))
#define EMAC_MAC_CSR(i) *((volatile int *)(EMAC_BASE(i) + 0x4))
#define EMAC_MD_MODE(i) *((volatile int *)(EMAC_BASE(i) + 0x8))
#define EMAC_MD_CONTROL(i) *((volatile int *)(EMAC_BASE(i) + 0xC))
#define EMAC_MD_STATUS(i) *((volatile int *)(EMAC_BASE(i) + 0x10))
#define EMAC_SRC_ADDR1(i) *((volatile int *)(EMAC_BASE(i) + 0x14))
#define EMAC_SRC_ADDR2(i) *((volatile int *)(EMAC_BASE(i) + 0x18))
#define EMAC_DST_ADDR1(i) *((volatile int *)(EMAC_BASE(i) + 0x1C))
#define EMAC_DST_ADDR2(i) *((volatile int *)(EMAC_BASE(i) + 0x20))
#define EMAC_TYPE(i) *((volatile int *)(EMAC_BASE(i) + 0x24))
#define EMAC_LEN_BORDER_RX(i) *((volatile int *)(EMAC_BASE(i) + 0x28))
#define EMAC_IFS_COLL_MODE(i) *((volatile int *)(EMAC_BASE(i) + 0x2C))
#define EMAC_UC_ADDR1(i) *((volatile int *)(EMAC_BASE(i) + 0x30))
#define EMAC_UC_ADDR2(i) *((volatile int *)(EMAC_BASE(i) + 0x34))
#define EMAC_MC_ADDR1(i) *((volatile int *)(EMAC_BASE(i) + 0x38))
#define EMAC_MC_ADDR2(i) *((volatile int *)(EMAC_BASE(i) + 0x3C))
#define EMAC_MC_ADDR_MASK1(i) *((volatile int *)(EMAC_BASE(i) + 0x40))
#define EMAC_MC_ADDR_MASK2(i) *((volatile int *)(EMAC_BASE(i) + 0x44))
#define EMAC_HASH_TABLE1(i) *((volatile int *)(EMAC_BASE(i) + 0x48))
#define EMAC_HASH_TABLE2(i) *((volatile int *)(EMAC_BASE(i) + 0x4C))
#define EMAC_AFDX_MODE(i) *((volatile int *)(EMAC_BASE(i) + 0x50))
#define EMAC_SEND_FR_TIMER(i) *((volatile int *)(EMAC_BASE(i) + 0x54))
#define EMAC_TXB_CSR(i) *((volatile int *)(EMAC_BASE(i) + 0x58))
#define EMAC_RXB_CSR(i) *((volatile int *)(EMAC_BASE(i) + 0x5C))
#define EMAC_INT_CSR(i) *((volatile int *)(EMAC_BASE(i) + 0x60))
#define EMAC_TX_FRAME_CNT(i) *((volatile int *)(EMAC_BASE(i) + 0x64))
#define EMAC_TX_STATUS(i) *((volatile int *)(EMAC_BASE(i) + 0x68))
#define EMAC_RX_FRAME_CNT(i) *((volatile int *)(EMAC_BASE(i) + 0x6C))
#define EMAC_RX_STATUS(i) *((volatile int *)(EMAC_BASE(i) + 0x70))
#define EMAC_RX_CTR(i) *((volatile int *)(EMAC_BASE(i) + 0x74))

#define EMAC_DMA_BASE(i) (0xb82FD800 + (i) * 0x1000)

#define EMAC_RX_DES_CSR(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0x0))
#define EMAC_RX_DES_CP(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0x4))
#define EMAC_RX_DES_IR(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0x8))
#define EMAC_RX_DES_RUN(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0xC))

#define EMAC_RX_DAT_CSR(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0x40))
#define EMAC_RX_DAT_CP(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0x44))
#define EMAC_RX_DAT_IR(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0x48))
#define EMAC_RX_DAT_RUN(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0x4C))

#define EMAC_TX_DES_CSR(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0x80))
#define EMAC_TX_DES_CP(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0x84))
#define EMAC_TX_DES_IR(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0x88))
#define EMAC_TX_DES_RUN(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0x8C))

#define EMAC_TX_DAT_CSR(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0xC0))
#define EMAC_TX_DAT_CP(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0xC4))
#define EMAC_TX_DAT_IR(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0xC8))
#define EMAC_TX_DAT_RUN(i) *((volatile int *)(EMAC_DMA_BASE(i) + 0xCC))

// 1553BIC
#define MIL_BASE 0xb8301800
#define MIL_OFFSET 0x1000
#define MAX_MIL_NUMBER 2
#define _1553BIC0 *((volatile int *)(0xb8301800))
#define _1553BIC1 *((volatile int *)(0xb8302800))

#define MASKR(i) *((volatile int *)(0xb82F4010 + 0x8 * i))
#define MASKR4 *((volatile int *)0xb82F4034)
#define QSTR(i) *((volatile int *)(0xb82F4014 + 0x8 * i))
#define QSTR4 *((volatile int *)0xb82F4038)
